                  ...
                  <?php if(count($test) > 0): ?>
                    <center><table>
                      ...
                      <?php $__currentLoopData = $test; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($loop->iteration); ?></td><td><?php echo e($tes->name); ?></td><td><a class="btn btn-link btn-primary" href="<?php echo e(route('tutor.test.detail')); ?>?id=<?php echo e($tes->id); ?>">Detail</a></td>
                        </tr>
        ...
        <div class="modal fade show" id="create-test-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none">
            <div class="modal-dialog">
                <div class="modal-content">
                  <form method="post" action="<?php echo e(route('tutor.test.create')); ?>" id="createTestForm">
